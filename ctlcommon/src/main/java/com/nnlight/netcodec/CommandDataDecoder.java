...
import com.nnlight.common.Dynamic;
...
public class CommandDataDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) {
        ...
        try {
            ...
            CommandData commandData = Dynamic.continuationCommand(data);
...
//            //检校码
//            commandData.setCheck(data[10 + iLength]);
//
...
//            }
            ...
            System.err.println("-----------------------CommandData 解码错误---------------------------");
            e.printStackTrace();
        }
    }
}
