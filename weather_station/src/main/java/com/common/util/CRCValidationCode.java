...
public class CRCValidationCode {
    public static String get16CRC(byte[] bytes) {
       ...
       /* char[] chars = hexStr.toCharArray();
        char[] newChar = {chars[2], chars[3], chars[0], chars[1]};
        String hexString = newChar.toString();*/
    ...
    public static void main(String[] args) {
        byte[] bytes = new byte[]{(byte) 0x02, (byte) 0x03, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x02};
        //crc16
