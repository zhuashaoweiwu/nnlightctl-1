...
public class BatchNettyClientCommand implements Command {

    private static final Logger logger = LoggerFactory.getLogger(BatchNettyClientCommand.class);

    public BatchNettyClientCommand(MessageEvent event, Produce produce) throws IOException {
        this();
